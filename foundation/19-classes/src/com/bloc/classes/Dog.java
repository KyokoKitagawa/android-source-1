...
class Dog {
    ...
    void setHairLength(float newHairLenght){
        mHairLength = newHairLenght;
    }
     ...
     *	Create the play method
     /************************************************/
         ...
         // numPlay = how many times dog played
         
         void play (){
             if (mWeight > MIN_WEIGHT + WEIGHT_LOSS){
                 mWeight -= WEIGHT_LOSS;
             }
             mPlay++;
             if (mPlay % 6 == 0){
     ...
     *	Create the cutHair method
     /************************************************/
        ...
        void cutHair (){
            if (mHairLength + HAIR_CUT_LENGTH >= 0)
